...
const BookingsCard = ({ booking }) => {
    ...
    const handleStatusChange = async () => {
        ...
        try {
            const response = await api.patch(`/bookings/${booking._id}`, { status: newStatus ,'confirmed_by_admin': true});
        ...
        >
            ...
            <div className="p-6 space-y-2">
                ...
                {!booking.archive &&
                                   ...
                                   className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium bg-secondColor rounded-full hover:bg-firstColor hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 h-9 px-3"
                               >
                                   Change status
                               </button>
                }
