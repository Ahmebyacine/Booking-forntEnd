...
const TotalBookingCardEmployee = () => {
    ...
    useEffect(() => {
        const fetchTotalBookings = async () => {
            ...
            try {
                ...
                setTotalBookings(data2024['Cancelled']['count']+data2024['Confirmed']['count']+data2024['Completed']['count']);
                setPercentageChange(data2024['Cancelled']['total_price']+data2024['Confirmed']['total_price']+data2024['Completed']['total_price']);
            } catch (error) {
...
export default TotalBookingCardEmployee;